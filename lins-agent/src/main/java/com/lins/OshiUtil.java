...
public class OshiUtil {
     ...
     * @throws Exception
     */
    public static com.lins.entity.SystemInfo os(CentralProcessor processor, OperatingSystem os) throws Exception {
        com.lins.entity.SystemInfo systemInfo = new com.lins.entity.SystemInfo();
     ...
     * @return
     */
    public static SysLoadState getLoadState(com.lins.entity.SystemInfo systemInfo, CentralProcessor processor) throws Exception {
