...
import com.lins.entity.DbTable;
import com.lins.entity.DbTableCount;
import com.lins.service.DbInfoService;
import com.lins.service.DbTableCountService;
import com.lins.service.DbTableService;
import com.lins.service.LogInfoService;
import com.lins.util.PageUtil;
import com.lins.util.jdbc.RDSConnection;
...
public class DbTableController {
    ...
    public String DbTableList(DbTable DbTable, Model model) {
        ...
        try {
            ...
            logInfoService.save("", "查询数据表信息错误", StaticKeys.LOG_ERROR);
    ...
    public String saveDbTable(DbTable DbTable, Model model, HttpServletRequest request) {
        try {
            ...
            logInfoService.save("", "保存数据表错误", StaticKeys.LOG_ERROR);
        }
    ...
    public String editDbTable(DbTable DbTable, Model model, HttpServletRequest request) {
        try {
            ...
            logInfoService.save("", "查看数据表错误", StaticKeys.LOG_ERROR);
        }
        return "mysql/add";
    }
    ...
    public String viewChartDbTable(DbTable DbTable, Model model, HttpServletRequest request) {
        try {
            ...
            logInfoService.save("", "查看数据表图表统计错误", StaticKeys.LOG_ERROR);
        }
        return "mysql/view";
    }
    ...
    public String delete(Model model, HttpServletRequest request, RedirectAttributes redirectAttributes) {
        ...
        try {
            if (!StringUtils.isEmpty(request.getParameter("id"))) {
                ...
                logInfoService.save("", "删除数据表：" + dbTable.getTableName(), StaticKeys.LOG_OPERATION);
